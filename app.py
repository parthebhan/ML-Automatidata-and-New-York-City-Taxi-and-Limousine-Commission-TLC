...
with open('https://github.com/parthebhan/ML-Automatidata-and-New-York-City-Taxi-and-Limousine-Commission-TLC/blob/main/Automatidata_gui.pickle', 'rb') as file:
